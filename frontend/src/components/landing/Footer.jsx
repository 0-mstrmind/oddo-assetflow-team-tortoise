export default function Footer() {
  ...
  return (
    <footer id="footer" className="bg-[#1E2022] text-white/60 mt-auto">
      <div className="af-container">
        {/* Main footer */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pt-16 pb-12">
          {/* Brand column */}
          <div className="col-span-2 md:col-span-1 mb-4 md:mb-0">
            ...
            <p className="text-xs text-white/40 leading-relaxed max-w-[200px]">
              Enterprise asset management designed for humans, not spreadsheets.
            </p>
          </div>
        ...
        <div className="border-t border-white/[0.06] py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#twitter" className="text-white/30 hover:text-white/60 transition-colors" aria-label="Twitter">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="#github" className="text-white/30 hover:text-white/60 transition-colors" aria-label="GitHub">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#linkedin" className="text-white/30 hover:text-white/60 transition-colors" aria-label="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
